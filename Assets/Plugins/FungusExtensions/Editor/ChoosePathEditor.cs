...
namespace Fungus
{
    ...
    [CustomEditor(typeof(Fungus.ChoosePath))]
    public class ChoosePathEditor : CommandEditor
    {
        ...
        protected SerializedProperty choosePathDialogProp;
        ...
        protected virtual void OnEnable()
        {
            ...
            choosePathDialogProp = serializedObject.FindProperty("setChoosePathDialog");
        }
        ...
        public override void DrawCommandGUI()
        {
            ...
            EditorGUILayout.PropertyField(choosePathDialogProp);
